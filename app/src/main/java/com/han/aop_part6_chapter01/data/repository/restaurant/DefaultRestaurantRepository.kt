package com.han.aop_part6_chapter01.data.repository.restaurant

import com.han.aop_part6_chapter01.data.entity.LocationLatLngEntity
import com.han.aop_part6_chapter01.data.entity.RestaurantEntity
...
class DefaultRestaurantRepository(
    ...
    override suspend fun getList(
        ...
        val response = mapApiService.getSearchLocationAround(
            ...
            centerLat = locationLatLng.latitude.toString(),
            centerLon = locationLatLng.longitude.toString(),
            searchType = "name",
            radius = "1",
